...
- Customer Portal Links (one link per customer, auto-generated on invoice creation)
  ...
  - Invoice detail: full view with line items, payment progress, PKR section, PDF download, "Send Proof of Payment" WhatsApp button (uploads to Dropbox, sends shareable link via wa.me)
  - Order detail: service progress tracking (view-only), formation dates, document upload (tagged as Customer/Admin), activity log
