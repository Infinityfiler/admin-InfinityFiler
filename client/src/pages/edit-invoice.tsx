  ...
  useEffect(() => {
    ...
    if (existingItems.length > 0) {
      setItems(existingItems.map(item => ({
        ...
        unit_price: item.original_price != null ? Number(item.original_price) : Number(item.unit_price),
                ...
                <div className="flex items-center gap-2">
                  {partnerRates.length > 0 && (
                    <Button size="sm" variant="outline" className="text-green-700 border-green-300" data-testid="button-recalculate-discounts" onClick={() => {
                      ...
                      toast({ title: "Unit prices reset to catalog prices — discounts applied automatically" });
